...
# ✅ Publishes .NET 9 WebAPI to ./PCMSApi/publish
publish:
	@echo "📦 Publishing .NET app..."
	dotnet publish ./PCMSApi/PCMSApi.csproj -c Release -o ./PCMSApi/publish /p:UseAppHost=false
	@echo "✅ Publish complete."

# ✅ Runs Docker Compose after publishing the app
run: publish
	@echo "🌀 Running Docker Compose..."
	docker compose down -v
	docker compose up -d

# ✅ Initializes LocalStack S3 bucket and uploads files
init-s3:
	@echo "🧠 Creating S3 bucket and uploading files..."
	docker exec -i localstack awslocal s3 mb s3://medical-files || true
